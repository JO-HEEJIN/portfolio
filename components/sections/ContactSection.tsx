        ...
        >
          ...
          <div className="bg-zinc-900/50 rounded-2xl p-8 border border-zinc-800">
            <p className="text-gray-300 mb-8">
              I&apos;m interested in engineering roles and collaborations where I can own
              production systems, investigate model behavior, and work closely with the people using them.
            </p>
                ...
                >
                  {card.href ? (
                    <a
                      ...
                      className="flex items-center gap-3 p-3 sm:p-4 bg-zinc-800/50 rounded-xl border border-zinc-700 hover:border-violet-500 transition-colors group"
                    >
                      <div className={`p-2 shrink-0 bg-zinc-700/50 rounded-xl ${card.color}`}>
                        {card.icon}
                      </div>
                      <div className="min-w-0 text-left">
                        <p className="text-sm text-gray-500">{card.label}</p>
                        <p className="text-sm sm:text-base break-words text-white font-medium group-hover:text-violet-400 transition-colors">
                          {card.value}
                        </p>
                      </div>
                    </a>
